# Fastify Presentation Route

This example shows a relying party verifying Mintra presentations on its own Fastify backend.
...
Use configured application and verifier origins here. Do not treat the incoming `Origin` header as the canonical verifier identity.
