    ...
    <div className="rounded-[32px] border border-line bg-white p-8 shadow-card sm:p-10">
      ...
      <div className="mt-6 rounded-2xl border border-line bg-fog px-4 py-3">
        ...
        <p className="mt-2 text-sm text-ink">
          {walletAddress ?? "No wallet linked yet. Connect a Mina wallet below before starting verification."}
        </p>
      </div>

      <p className="mt-6 text-sm leading-6 text-slate">
        {freshnessStatus === "verified"
          ? "Verification is current. Your credential can be issued into a supported wallet below or refreshed any time."
          : freshnessStatus === "expiring_soon"
            ...
            : freshnessStatus === "expired"
              ...
              : walletAddress
                ...
                : "Connect a Mina wallet below first, then come back up to start verification."}
      </p>
    </div>
  );
}
